#!/usr/bin/env python3
"""Run Qwen3-VL or Qwen3-VL+LoRA inference on Showee eval sets."""
...
DEFAULT_EVAL = PROJECT_ROOT / "eval/sets/showee_val_v001.json"
DEFAULT_OUTPUT = PROJECT_ROOT / "eval/results/showee_val_v001_predictions.jsonl"
