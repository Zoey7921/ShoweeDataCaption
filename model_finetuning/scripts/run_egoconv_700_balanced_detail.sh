...
OUTPUT="$PROJECT_ROOT/eval/results/egoschema_lora_v001_challenge2_egoconv_700_balanced_detail_predictions.jsonl"
GOLDEN="$RUN_DIR/golden.jsonl"
REPORT="$RUN_DIR/run_report.json"
EVAL_OUTPUT="$PROJECT_ROOT/eval/results/egoschema_lora_v001_challenge2_egoconv_700_balanced_detail_results.json"
